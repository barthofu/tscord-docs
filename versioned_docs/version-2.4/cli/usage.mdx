...
:::info
The CLI auto-detects your current TSCord version and adapts the generated files to this version. <br/>Just keep in mind to update the CLI if you want to generate files for a brand new version prior to when you've installed the CLI.
:::
