...
|-------------------------|-----------------------------------------------------------------------------------------|--------------------------------------|
| `templateReady`         | Emitted once the application has fully started (including api/websocket servers, etc)   | `src/events/custom/templateReady.ts` |
| `simpleCommandCreate`         | Emitted on simple interaction command   | `src/events/custom/templateReady.ts` |
