...
:::info
It is a **[global guard](https://discord-ts.js.org/docs/decorators/general/guard#global-guards)** applied on the bot client directly, you don't have to touch it nor use it!
:::
...
#### More info [here](https://github.com/oceanroleplay/discord.ts/tree/main/packages/utilities#permissionguard).
